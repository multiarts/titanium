          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex justify-content-between">
                ...
                {{-- <p class="text-secondary">Chamado aberto por: {{ Auth()->user()->name }}, em <span
                  class="date"></span> --}}
                </p>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="col-md-3">
                  <div class="row">
                    <label for="tecnico_id">Técnico &nbsp; &nbsp;&nbsp;&nbsp;<a href="" id="newTecnico"
                        data-toggle="modal" data-target="#tecnicoModal"
                        class="text-right btn btn-flat btn-outline-info btn-xs">Novo</a>
                    </label>
                  </div>
