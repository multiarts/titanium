...
@section('title', 'Chamados concluídos')
		...
		<div class="card">
			<div class="card-header border-0">
				<div class="d-flex justify-content-between">
					...
					<a href="{{ route('dashboard.chamados.create') }}" class="btn btn-sm btn-success"><i class="fad fa-plus"></i>
						Novo</a>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						@if($chamados->count() < 1) <div class="alert alert-danger alert-with-icon">
							...
							<h6><i class="fad fa-info"></i> Não há chamados.</h6>
					</div>
					@else
						...
						<tbody>
							...
							<tr>
								...
								<td class="td-actions text-right">
									...
									<a href="{{ route('dashboard.chamados.edit', $chamado->number) }}" class="btn btn-sm text-warning" title="Editar">
										<i class="fad fa-edit"></i>
									</a>
								</td>
							</tr>
