...
@section('title', 'Subclientes')

@section('content_header')
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Subclientes</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        ...
        <div class="card card-outline card-navy">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">Gerenciamento de Subclientes</h3>
                    <a href="{{ route('dashboard.subclientes.create') }}"
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        @if ($subclient->count() < 1)
                        <h5><i class="fad fa-info"></i> Não há subclientes.</h5>
                        @else
                                ...
                                @foreach ($subclient as $c)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a href="{{ route('dashboard.subclientes.show', $c->id) }}" id="getChamadom" class="btn btn-sm text-info" data-toggle="modalm"
                                                data-target="#viewChamadom" title="Ver detalhes"
                                                data-url="{{ route('dashboard.subclientes.show', $c->id) }}">
                                                <i class="fad fa-eye"></i>
                                            </a>
        
                                            <a href="{{ route('dashboard.subclientes.edit', $c->id) }}"
                                            ...
                                            <a class="btn btn-sm delete-confirm text-red" title="Excluir" data-toggle="modal"
                                                data-target="#delete"
                                                onclick="confirmDelete('{{ route('dashboard.subclientes.destroy', $c->id) }}')">
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content deleteContent">
			<div class="modal-header bg-danger">
				<h5 class="modal-title" id="chamadoModalLabel">Excluir subcliente?</h5>
